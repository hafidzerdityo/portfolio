...
const stats = [
  { icon: Clock, value: "5+", title: "Years Exp." },
      ...
      <div className="max-w-4xl mx-auto px-6 space-y-24">
        ...
        <section className="space-y-8">
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl">
            I build resilient microservices and high-performance backend
            systems. Specializing in fintech and sharia-compliant banking
            solutions for major institutions.
          </p>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {techStackList.map((tech, idx) => (
                ...
                >
                  <div
                    className={`w-8 h-8 rounded-md flex items-center justify-center text-white ${tech.color} shrink-0`}
                  >
        ...
        <section className="pt-8 pb-8">
          <div className="bg-secondary/30 rounded-2xl p-8 md:p-12 text-center space-y-6">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              Interested in building scalable backend systems? Reach out and
