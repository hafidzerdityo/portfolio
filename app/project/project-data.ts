...
export const projectList: ProjectItem[] = [
  ...
  },
  {
    ...
    link: null,
    date: "March 2023",
    desc: "Built scalable backend API systems for PosGiro Cash, a welfare cash management system. Developed with Go Fiber, implemented RESTful endpoints, and containerized services with Docker for smooth deployment and maintenance, improving operational efficiency.",
    tag: [
